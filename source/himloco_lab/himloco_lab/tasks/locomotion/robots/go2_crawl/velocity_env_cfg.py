...
from himloco_lab.assets.unitree import UNITREE_GO2_CRAWL_CFG as ROBOT_CFG
...
class TerminationsCfg:
    ...
    base_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="base"), "threshold": 50.0},
    )
